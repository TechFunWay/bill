...
export default {
  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        sans: ['Manrope', 'system-ui', '-apple-system', 'PingFang SC', 'Microsoft YaHei', 'sans-serif'],
        display: ['Manrope', 'system-ui', '-apple-system', 'PingFang SC', 'sans-serif'],
        mono: ['IBM Plex Mono', 'SFMono-Regular', 'Consolas', 'monospace'],
      },
      boxShadow: {
        soft: '0 1px 0 rgba(24, 37, 30, 0.05), 0 10px 24px -16px rgba(24, 37, 30, 0.28)',
        card: '0 1px 0 rgba(24, 37, 30, 0.05), 0 18px 42px -26px rgba(24, 37, 30, 0.35)',
        glow: '0 0 0 1px rgb(var(--color-accent) / 0.22), 0 10px 28px -12px rgb(var(--color-brand-900) / 0.45)',
      },
      backgroundImage: {
        'brand-gradient':
          'linear-gradient(135deg, rgb(var(--color-brand-800)) 0%, rgb(var(--color-brand-600)) 100%)',
      },
      keyframes: {
        'fade-in': {
