...
<style scoped>
.ui-btn {
  @apply inline-flex items-center justify-center gap-2 rounded-full font-bold outline-none transition-all active:scale-[0.98] disabled:pointer-events-none disabled:opacity-50;
}
...
.ui-btn--primary {
  @apply bg-brand-800 text-white shadow-soft hover:bg-brand-700 dark:bg-accent dark:text-brand-900;
}
.ui-btn--ghost {
