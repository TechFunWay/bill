...
func init() {
	...
	RegisterConfig(ConfigDef{
		...
		Default: "30", Public: true,
		Group: "access", Label: "记住登录有效天数",
		Description: "勾选记住登录后保持登录状态的天数，范围 1–365，新登录生效",
	})
	RegisterConfig(ConfigDef{
